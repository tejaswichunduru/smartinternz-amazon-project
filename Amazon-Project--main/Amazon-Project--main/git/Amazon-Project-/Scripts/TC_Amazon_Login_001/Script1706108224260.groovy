...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_email'), 'tejaswichunduru2003@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_password'), 'tejaswi@98765')
